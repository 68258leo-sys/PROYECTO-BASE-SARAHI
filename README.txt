...
- Desarrollar la operación de raíz cuadrada en la clase OperacionesAvanzadas del archivo avanzadas.py.
- Agregar un método llamado raizCuadrada() que calcule la raíz cuadrada del num1 (usa import math y math.sqrt).
